  ...
  return (
    ...
    <section className="footer">
        <div className="box-container">
          <div className="box">
            <h3>Address</h3>
            <a href="googlemaplink">IIIT UNA, Himachal Pradesh</a>
        ...
        <div className="box">
            <h3>Contact Us </h3>
                ...
                <i className="fa">
                <a href="tel:+91 8630239748">+91 8630239748 </a></i>  
                <br></br>
                <i className="fa">
                <a href="mailto:parastyagi1105@gmail.com">parastyagi1105@gmail.com</a></i>
            </div>
        <div className="box">
            <h3>Follow us</h3>
            <link
    ...
    <div className="credits">
        <p>© 2024 Una. All Rights Reserved.</p>
      </div>
    </div>
    </>
  );
